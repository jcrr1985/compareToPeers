...
$(event.chart.dataProvider).each( function() {
  ...
  textNode = document.createTextNode(this.category);
 ...
 var g = document.createElementNS("http://www.w3.org/2000/svg", "g");
    g.setAttribute("id","yourAnsWrapper")
    g.appendChild(circle1)
    g.appendChild(circle2)
    g.appendChild(text)
    g.appendChild(yourAns)
  ...
  var vsgo = document.createElementNS("http://www.w3.org/2000/svg", "circle");
  vsgo.setAttribute("cy", 80)
  vsgo.setAttribute("id", "magicDot")
  vsgo.setAttribute("cx", 130)
  vsgo.setAttribute("r", 1)
  vsgo.setAttribute("fill", "white")

  var magicLine = document.createElementNS("http://www.w3.org/2000/svg", "line");
    magicLine.setAttribute("x1",130)
    magicLine.setAttribute("id","magicLine")
    magicLine.setAttribute("x2",1)
    magicLine.setAttribute("y1",80)
    magicLine.setAttribute("y2",80) 
    magicLine.setAttribute("stroke","white") 
    magicLine.setAttribute("stroke-witdh",1) 

    setTimeout(function(){
      svgAnswer1.appendChild(magicLine)
    },2000)

   svgAnswer1.appendChild(vsgo)
